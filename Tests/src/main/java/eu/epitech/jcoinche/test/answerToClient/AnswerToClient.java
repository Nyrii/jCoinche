...
import eu.epitech.jcoinche.test.protobuf.Game;
import eu.epitech.jcoinche.test.gameManager.GameManager;
import io.netty.channel.ChannelHandlerContext;
import org.apache.commons.lang3.StringUtils;

import java.util.ArrayList;

import static eu.epitech.jcoinche.test.protobuf.Game.Answer.Type.*;
import static eu.epitech.jcoinche.test.protobuf.Game.Answer.Type.PLAYER;
import static eu.epitech.jcoinche.test.protobuf.Game.Answer.Type.SETTINGS;
...
public class AnswerToClient {
    ...
    public static boolean nameAlreadyInUse(ArrayList nameClient, String name) {
        if (nameClient == null)
            return false;
    ...
    private static boolean addName(ArrayList nameClient, String id, String name) {
        if (nameClient == null || name.length() < 4 || !StringUtils.isAlphanumeric(name))
            return false;
        for (int i = 0; i < nameClient.size(); i++) {
